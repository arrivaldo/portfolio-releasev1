  ...
  return (
    <>
      <section className="p-contact" style={{ marginTop: "5%" }}>
        <h3 className="text-slate-50 text-xl mobile:text-[1.05rem] font-bold text-left mobile:mb-4 mobile:mt-4">
          Let's Collaborate!
        </h3>
        ...
        <form style={{ marginTop: "2%" }} className=" mx-auto">
          <div className="relative z-0 w-full mb-5 group">
            <input
              ...
              name="floating_email"
              id="floating_email"
              className="block py-2.5 px-0 w-full text-lg mobile:text-[0.9rem] text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
              placeholder=" "
              required
            />
            <label
              htmlFor="floating_email"
              className="peer-focus:font-medium absolute text-lg mobile:text-[0.9rem] text-gray-500 dark:text-gray-400 duration-300 transhtmlForm -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
            >
              Email address
            </label>
          </div>
  ...
  <textarea style={{border: '2px solid rgb(209 213 219', marginBottom: '2%', background: 'transparent'}} id="message" rows="4" className="block p-2.5 w-full text-sm text-gray-900  rounded-lg border focus:ring-blue-500 focus:border-blue-500" placeholder="Leave a comment..."></textarea>
          ...
          <div className="group">
            <button
              ...
              type="submit"
              className="text-white mobile:text-[0.9rem] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-lg w-full sm:w-auto px-5 py-2.5 text-center"
            >
              Submit
            </button>
            <button
