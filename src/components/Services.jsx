        ...
        <div ref={spotlightRef} className="services-container">
            ...
            >
              <div className="service-box4 flex flex-col justify-between h-24">
                <div className="flex items-center  justify-between">
                  ...
                  <h3 className="hidden mobile:block text-xl tinyMobile:text-[1.05rem] mobile:text-[1.05rem] mobileBig:text-[1.05rem]">
          ...
          <div style={{ padding: "2px" }}>
            ...
            >
              <div className="service-box4 flex flex-col justify-between h-24">
                <div className="flex items-center  justify-between">
                  <h3 className="text-xl mobile:hidden mobile:text-[1.05rem]">
                    QA Analyst
                  </h3>
                  <h3 className="hidden mobile:block text-xl mobile:text-[1.05rem]">
                    Quality Analyst
                  </h3>
                </div>
