  ...
  return (
    <>
      <div className="w-full border  rounded-lg shadow ">
        <ul
          className="flex flex-wrap text-lg font-medium text-center text-gray-200 border-b border-gray-200 rounded-t-lg "
          id="defaultTab"
        ...
        <div id="defaultTabContent">
          <div
            className=" p-4 bg-transparent rounded-lg md:p-8"
            id="about"
            role="tabpanel"
          ...
          <div
            className="hidden p-4 rounded-lg md:p-8 "
            id="services"
            role="tabpanel"
